...
<table border="0" cellpadding="1" cellspacing="1" align="left" style="border-collapse: collapse;"> 
  <tbody> 
    <tr> <td><img src="/img/phone.png"  /></td> <td style="font-size: 14px;"><span style="position: relative; top: -1px; display:none;">+7(499)709-77-90</span> </td> <td style="padding: 13px;"> 
<style>
a.zingaya_button {
display: block;
width: 120px;
