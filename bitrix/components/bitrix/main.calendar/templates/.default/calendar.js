...
function JCCalendar()
{
	...
	this.InsertPeriod = function(value1, value2)
	{
		if(null != this.fieldFrom && null != this.fieldTo)
		{
			...
			if(this.fieldFrom.onchange && typeof(this.fieldFrom.onchange) == 'function')
				this.fieldFrom.onchange();
			if(this.fieldTo.onchange && typeof(this.fieldTo.onchange) == 'function')
				this.fieldTo.onchange();
		}
		else
		{
