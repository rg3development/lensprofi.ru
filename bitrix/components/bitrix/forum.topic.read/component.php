...
********************************************************************/
	if ($arParams["MID"] > 0):
		...
		if (empty($res)):
			LocalRedirect(CComponentEngine::MakePathFromTemplate($arParams["~URL_TEMPLATES_READ"], array("FID" => $arParams["FID"], "TID" => $arParams["TID"], "MID" => "s")));
		else:
...
$iNumPage = 0;
if ($arParams["MID"] > 0)
	$iNumPage = CForumMessage::GetMessagePage($arParams["MID"], $arParams["MESSAGES_PER_PAGE"], $arUserGroups, $arParams["TID"]);
