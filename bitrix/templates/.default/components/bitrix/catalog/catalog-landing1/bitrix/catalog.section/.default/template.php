...
<table cellpadding="0" cellspacing="0" border="0" class="landing-table">
		...
		<td valign="top" width="<?=round(100/$arParams["LINE_ELEMENT_COUNT"])?>%" id="<?=$this->GetEditAreaId($arElement['ID']);?>">
			<table cellpadding="0" cellspacing="2" border="0"  style="width:100% !important;">
				<tr>
					<td valign="top" style="width:100% !important; min-height: 20px;"><a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a><br />
