		...
		<td valign="top" width="<?=round(100/$arParams["LINE_ELEMENT_COUNT"])?>%" id="<?=$this->GetEditAreaId($arElement['ID']);?>">
			<table cellpadding="0" cellspacing="2" border="0"  style="width:100% !important;">
				<tr>
					...
					<?endif?>
					<td valign="top" style="width:100% !important; min-height: 40px;"><a href="<?=$arElement["DETAIL_PAGE_URL"]?>"><?=$arElement["NAME"]?></a><br />
			...
			<?else:?>
				...
				<?if($arElement["CAN_BUY"]):?>
						...
						<a href="<?echo $arElement["BUY_URL"]?>" rel="nofollow" class="button"><img src="/img/buy-button.png"></a>
						</noindex>
