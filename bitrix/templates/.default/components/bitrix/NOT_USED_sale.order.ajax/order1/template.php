						...
						<td>
							...
							*/?>
							...
							<table >
								...
								<tr>
									<td style="vertical-align: top"><input style="position: inherit; top: 0px" id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][8]["FIELD_NAME"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][8]["FIELD_NAME"]?>"  type="text" class="w196 rel10" value="<?=($arResult["ORDER_PROP"]["USER_PROPS_Y"][8]["VALUE"]=='')?'Город':$arResult["ORDER_PROP"]["USER_PROPS_Y"][8]["VALUE"]?>" onfocus="if(this.value=='Город') this.value='';" onblur="if(this.value=='') this.value='Город';" /></td>
								</tr>
								<tr>
									<td colspan="2">
										<span>Напишите адрес доставки и при необходимости дополнительную информацию:</span><input id="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][9]["FIELD_NAME"]?>" name="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][9]["FIELD_NAME"]?>" value="<?=$arResult["ORDER_PROP"]["USER_PROPS_Y"][9]["VALUE"]?>" type="text" class="w450" /><br /><br />
									</td>
								</tr>
							</table>
						</td>
			...
			<div class="performance">
				<table style="width: 440px">
					<tr>
						...
						<td style="border-right: 1px solid #cacbcb; padding-right: 10px; text-align: right"><?=$arResult['ORDER_PRICE_FORMATED']?></td>
					</tr>
					<?/*
					<tr>
					...
					*/?>
					<?if($arResult['DISCOUNT_PRICE']>0):?>
						...
						<td style="border-right: 1px solid #cacbcb; padding-right: 10px; text-align: right"><?=$arResult['DISCOUNT_PRICE_FORMATED'];?></td>
					</tr>
					<?endif;?>
