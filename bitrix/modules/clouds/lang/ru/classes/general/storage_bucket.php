...
$MESS["CLO_STORAGE_WRONG_BUCKET_NAME_LENGTH"] = "Длина идентификатора контейнера должна быть не менее 3-х символов и не более 64-х.";
$MESS["CLO_STORAGE_WRONG_BUCKET_NAME_LENGTH2"] = "Длина компонента идентификатора контейнера (подстрока между точками) должна быть не менее 3-х символов и не более 64-х.";
