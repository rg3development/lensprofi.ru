...
$strAll.= "<name>".htmlspecialchars($APPLICATION->ConvertCharset(COption::GetOptionString("main", "site_name", ""), LANG_CHARSET, 'windows-1251'))."</name>\n";
$strAll.= "<company>".htmlspecialchars($APPLICATION->ConvertCharset(COption::GetOptionString("main", "site_name", ""), LANG_CHARSET, 'windows-1251'))."</company>\n";
...
$strExportPath = COption::GetOptionString("catalog", "export_default_path", "/upload/");
CheckDirPath($_SERVER["DOCUMENT_ROOT"].$strExportPath);
$strYandexPath = str_replace('//','/',$strExportPath."/yandex.php");
