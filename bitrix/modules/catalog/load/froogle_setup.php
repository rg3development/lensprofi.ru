...
<!-- 					<select name="IBLOCK_ID" OnChange="ClearSelected(); document.getElementById('ifr').src='/bitrix/tools/catalog_export/froogle_util.php?IBLOCK_ID='+this[this.selectedIndex].value+'&'+'<? echo bitrix_sessid_get(); ?>';">
...
//										space = '<input type="checkbox" name="V[]" value="'+i+'"><a href="' + Tree[node][i][1] + '">' + Tree[node][i][0] + '</a>';
			...
			<tr>
				...
				<td width="100%" valign="top">
					<font class="text"><b><?echo GetMessage("CET_SAVE_FILENAME");?></b> <input type="text" name="SETUP_FILE_NAME" value="<?echo htmlspecialchars(strlen($SETUP_FILE_NAME)>0 ? $SETUP_FILE_NAME : (COption::GetOptionString("catalog", "export_default_path", "/upload/"))."froogle_".mt_rand(0, 999999).".txt"); ?>" size="50">
					</font>
					<br><br>
				</td>
			</tr>
			...
			<?if ($ACTION=="EXPORT_SETUP" || $ACTION == 'EXPORT_EDIT' || $ACTION == 'EXPORT_COPY'):?>
				<tr>
					...
					<td width="100%" valign="top">
						<font class="text"><b>
						<?echo GetMessage("CET_PROFILE_NAME");?> <input type="text" name="SETUP_PROFILE_NAME" value="<? echo (strlen($SETUP_PROFILE_NAME) > 0 ? htmlspecialchars($SETUP_PROFILE_NAME) : ''); ?>" size="30">
						</b></font>
						<br><br>
					</td>
				</tr>
