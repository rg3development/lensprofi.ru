...
Class catalog extends CModule
{
	...
	function InstallFiles()
	{
		...
		$ToDir = $DOCUMENT_ROOT."/bitrix/catalog_export/";
		CheckDirPath($ToDir);

		$ToDir = $DOCUMENT_ROOT."/bitrix/tools";
		CopyDirFiles($DOCUMENT_ROOT."/bitrix/modules/catalog/install/tools", $ToDir);
	...
	function UnInstallFiles()
	{
		...
		DeleteDirFiles($DOCUMENT_ROOT."/bitrix/modules/catalog/install/tools", $DOCUMENT_ROOT."/bitrix/tools");
