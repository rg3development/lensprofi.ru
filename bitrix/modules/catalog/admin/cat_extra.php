...
$arHeaders = array(
	...
	array("id"=>"NAME","content"=>GetMessage("EXTRA_NAME"), "sort"=>"NAME", "default"=>true),
	array("id"=>"PERCENTAGE", "content"=>GetMessage('EXTRA_PERCENTAGE'),	"sort"=>"PERCENTAGE", "default"=>true),
);
...
while ($arExtra = $dbResultList->NavNext(true, "f_"))
{
	...
	$arActions = Array();
	$arActions[] = array("ICON"=>"edit", "TEXT"=>GetMessage("CEN_UPDATE_ALT"), "ACTION"=>$lAdmin->ActionRedirect("/bitrix/admin/cat_extra_edit.php?ID=".$f_ID."&lang=".LANGUAGE_ID /*."&".GetFilterParams("filter_").""*/), "DEFAULT"=>true);
