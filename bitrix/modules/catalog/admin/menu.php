			...
			while ($ce_ar_res = $ce_db_res->Fetch())
			{
				if ($ce_ar_res['DEFAULT_PROFILE'] == 'Y')
				{
					$expItems[] = Array(
						...
						"url" 	=>	"cat_exec_exp.php?ACT_FILE=".$ce_ar_res["FILE_NAME"]."&ACTION=EXPORT&PROFILE_ID=".$ce_ar_res["ID"]."&lang=".LANGUAGE_ID."&".bitrix_sessid_get(),
						"title"=>GetMessage("CAM_EXPORT_DESCR_EXPORT")." &quot;".htmlspecialchars($ce_ar_res["NAME"])."&quot;",
				...
				else
				{
					$expItems[] = Array(
						"text" 	=> htmlspecialchars((strlen($ce_ar_res["NAME"])>0 ? $ce_ar_res["NAME"] : $ce_ar_res["FILE_NAME"])),
						"url" 	=>	"cat_export_setup.php?ACT_FILE=".$ce_ar_res["FILE_NAME"]."&ACTION=EXPORT_EDIT&PROFILE_ID=".$ce_ar_res["ID"]."&lang=".LANGUAGE_ID."&".bitrix_sessid_get(),
						"title"=>GetMessage("CAM_EXPORT_DESCR_EDIT")." &quot;".htmlspecialchars($ce_ar_res["NAME"])."&quot;",
		...
		if($adminMenu->IsSectionActive("mnu_catalog_imp") || $page == "/bitrix/admin/cat_import_setup.php" || $page == "/bitrix/admin/cat_exec_imp.php")
		{
			...
			while ($ce_ar_res = $ce_db_res->Fetch())
			{
				if ($ce_ar_res['DEFAULT_PROFILE'] == 'Y')
				{
					$impItems[] = Array(
						"text"	=> htmlspecialchars((strlen($ce_ar_res["NAME"])>0 ? $ce_ar_res["NAME"] : $ce_ar_res["FILE_NAME"])),
						"url"	=> "cat_exec_imp.php?ACT_FILE=".$ce_ar_res["FILE_NAME"]."&ACTION=IMPORT&PROFILE_ID=".$ce_ar_res["ID"]."&lang=".LANGUAGE_ID."&".bitrix_sessid_get(),
						"title"=>GetMessage("CAM_IMPORT_DESCR_IMPORT")." &quot;".htmlspecialchars($ce_ar_res["NAME"])."&quot;",
				...
				else
				{
					$impItems[] = Array(
						"text"	=> htmlspecialchars((strlen($ce_ar_res["NAME"])>0 ? $ce_ar_res["NAME"] : $ce_ar_res["FILE_NAME"])),
						"url"	=> "cat_import_setup.php?ACT_FILE=".$ce_ar_res["FILE_NAME"]."&ACTION=IMPORT_EDIT&PROFILE_ID=".$ce_ar_res["ID"]."&lang=".LANGUAGE_ID."&".bitrix_sessid_get(),
						"title"=>GetMessage("CAM_IMPORT_DESCR_EDIT")." &quot;".htmlspecialchars($ce_ar_res["NAME"])."&quot;",
