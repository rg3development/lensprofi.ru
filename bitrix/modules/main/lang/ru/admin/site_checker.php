...
$MESS["SC_HELP_CHECK_MYSQL_TABLE_STATUS"] = "Используется механизм MySQL для проверки целостности таблиц. Если какие-то таблицы разрушены, предлагается запустить механизим исправления ошибок базы.";
...
";
$MESS["SC_HELP_CHECK_BACKTRACK_LIMIT"] = "В php есть ограничение на длину строки при работе с регулярными выражениями. Параметр называется <i>pcre.backtrack_limit</i>.
