...
if (($res = CCheckListResult::GetList(Array(),Array("REPORT"=>"N"))->Fetch())||($_POST["bx_start_test"] == "Y") || $_POST["ACTION"]):
	...
	if ($_POST["ACTION"] == "update")
	{
		...
		//////////////JSON ANSWER/////////////////
		//////////////////////////////////////////
		$arResult["PARENT"] = $arParentStat;
		$arResult["PARENT"]["ID"] = $arParentCode;
		$arResult["SUB_PARENT"] = $arSubParentStat;
		$arResult["SUB_PARENT"]["ID"] = $arSubParentCode;
		$arResult["TEST_ID"]=$arTestID;
		$arResult["CAN_CLOSE_PROJECT"]=($_POST["COMMENTS"] == "Y")?"N":$arTotal["CHECKED"];
		$arResult["TOTAL"]=$arTotal["TOTAL"];
		$arResult["FAILED"]=$arTotal["FAILED"];
		$arResult["SUCCESS"]=$arTotal["CHECK"];
		$arResult["REQUIRE"]=$arTotal["REQUIRE"];
		$arResult["REQUIRE_CHECK"]=$arTotal["REQUIRE_CHECK"];
		$arResult["WAITING"]=$arTotal["WAITING"];
		$arResult["MAIN_STAT"] = Array(
