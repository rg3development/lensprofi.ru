...
$IBLOCK_RIGHT = CIBlock::GetPermission($iblock_id);
if ('R' > $IBLOCK_RIGHT)
{
...
if (isset($_REQUEST['win_id']))
{
	...
	{
		ShowError(GetMessage("BT_COMP_MTS_AJAX_ERR_WIN_ID_ABSENT"));
		die();
	}
	else
	{
...
<div class="content" id="_f_popup_content" style="height: 400px; overflow-x: hidden; oveflow-y: auto; padding: 0;"><input id="bx_emp_search_control" type="text" style="width: 99.99%" value="" autocomplete="off" />
