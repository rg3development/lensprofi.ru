...
function __AddPropCellName($intOFPropID,$strPrefix,$arPropInfo)
{
	...
	?>
	<input type="text" size="20"  maxlength="100" name="<?echo $strPrefix.$intOFPropID?>_NAME" id="<?echo $strPrefix.$intOFPropID?>_NAME" value="<?echo $arPropInfo['NAME']?>">
	<?
	...
	<tr>
		<td valign="top" colspan="2">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="internal" align="center" id="ib_prop_list">
				...
				if (0 < $ID)
				{
					$rsProps =  CIBlockProperty::GetList(array("sort"=>"asc"), array("IBLOCK_ID" => $ID, "CHECK_PERMISSIONS" => "N"));
					while ($arProp = $rsProps->Fetch())
					{
