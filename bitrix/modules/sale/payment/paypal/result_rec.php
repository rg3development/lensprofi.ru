...
if(strlen($req) > 0)
{
	...
	if($fp)
	{
		...
		{
			$strPS_STATUS_MESSAGE = "";
			$strPS_STATUS_MESSAGE .= "Name: ".$_POST["first_name"]." ".$_POST["last_name"]."; ";
			$strPS_STATUS_MESSAGE .= "Email: ".$_POST["payer_email"]."; ";
			$strPS_STATUS_MESSAGE .= "Item: ".$_POST["item_name"]."; ";
			$strPS_STATUS_MESSAGE .= "Amount: ".$_POST["mc_gross"]."; ";
...
You can view order status in personal section on <a href="/personal/">our site</a>.
