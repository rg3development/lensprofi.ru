...
if($arOrder = $dbOrder->GetNext())
{
	...
	$dbBasket = CSaleBasket::GetList(
			...
			false,
			false,
			array("ID", "DETAIL_PAGE_URL", "NAME", "NOTES", "QUANTITY", "PRICE", "CURRENCY", "PRODUCT_ID", "DISCOUNT_PRICE", "WEIGHT", "CATALOG_XML_ID", "VAT_RATE")
		);
	...
	while ($arBasket = $dbBasket->Fetch())
	{
		...
		$arBasketTmp["WEIGHT_FORMATED"] = roundEx(DoubleVal($arBasketTmp["WEIGHT"]/$arResult["WEIGHT_KOEF"]), SALE_VALUE_PRECISION)." ".$arResult["WEIGHT_UNIT"];
