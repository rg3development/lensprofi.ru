...
$date_before_last_month2 = ConvertTimeStamp(AddToTimeStamp(array("DD" => -1, "MM" => -1, "YYYY" => 0, "HH" => 0, "MI" => 0, "SS" => 0), mktime(0, 0, 0, date("n"), 1, date("Y"))));
?>
...
<div class="bx-gadgets-tabs-wrap" id="bx_gd_tabset_sale_<?=$arGadgetParams["RND_STRING"]?>">
	<div class="bx-gadgets-tabs">
		<span onclick="gdSaleTabControl_<?=$arGadgetParams["RND_STRING"]?>.SelectTab(this)" id="bx_gd_sale_stats_<?=$arGadgetParams["RND_STRING"]?>" class="bx-gadgets-tab-wrap bx-gadgets-tab-active bx-gadgets-tab-first"><span class="bx-gadgets-tab-left"></span><span class="bx-gadgets-tab-text"><?=GetMessage("GD_ORDERS_TAB_STATS")?></span><span class="bx-gadgets-tab-right"></span></span>	
		<span onclick="gdSaleTabControl_<?=$arGadgetParams["RND_STRING"]?>.SelectTab(this)" id="bx_gd_sale_orders_<?=$arGadgetParams["RND_STRING"]?>" class="bx-gadgets-tab-wrap"><span class="bx-gadgets-tab-left"></span><span class="bx-gadgets-tab-text"><?=GetMessage("GD_ORDERS_TAB_ORDERS")?></span><span class="bx-gadgets-tab-right"></span></span>
	</div>
	<div class="bx-gadgets-tabs-cont">
		<div id="bx_gd_sale_stats_<?=$arGadgetParams["RND_STRING"]?>_content" style="display: block;">
		...
		<div id="bx_gd_sale_orders_<?=$arGadgetParams["RND_STRING"]?>_content" style="display: none;">
			<?
			if (count($arOrders) > 0)
			{
				?>
				<table class="bx-gadgets-table">
					<tbody>
						...
						foreach($arOrders as $arOrder)
						{
							?>
							<tr>
								<td align="left" style="vertical-align: top;"><a href="/bitrix/admin/sale_order_detail.php?ID=<?=$arOrder["ID"]?>&lang=<?=LANGUAGE_ID?>"><?=GetMessage("GD_ORDERS_ORDER_1")?><?=$arOrder["ID"]?></a><br><?=$arOrder["DATE_INSERT"]?></td>
								<td align="left" style="vertical-align: top;"><?=CurrencyFormat($arOrder["PRICE"], $arOrder["CURRENCY"])?></td>
								<td align="left" style="vertical-align: top;"><a href="/bitrix/admin/user_edit.php?ID=<?=$arOrder["USER_ID"]?>&lang=<?=LANGUAGE_ID?>"><?=$arOrder["USER_NAME"]." ".$arOrder["USER_LAST_NAME"]?></a></td>
			...
			?>
			<div style="padding: 10px 0 0 0;"><a href="/bitrix/admin/sale_order.php?lang=<?=LANGUAGE_ID?>"><?=GetMessage("GD_ORDERS_ALL_ORDERS")?></a></div>
		</div>
	</div>
</div>
