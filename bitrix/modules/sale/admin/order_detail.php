...
$WEIGHT_UNIT = htmlspecialchars(COption::GetOptionString('sale', 'weight_unit', "", $arOrder["LID"]));
$WEIGHT_KOEF = htmlspecialchars(COption::GetOptionString('sale', 'weight_koef', 1, $arOrder["LID"]));
							...
							<form method="get" action="/bitrix/admin/sale_order_detail.php" name="change_cancel">
								...
								<div id="viewCancelDIV" style="display: block;">
									...
									if ($arOrder["CANCELED"] == "Y" && strlen($arOrder["REASON_CANCELED"]) > 0)
										echo "<br>".htmlspecialcharsEx($arOrder["REASON_CANCELED"]);
									?>
								</div>
						...
						<table cellpadding="3" cellspacing="1" border="0" width="100%" class="internal">
							...
							while ($arBasket = $dbBasket->Fetch())
							{
								...
								<tr>
									...
									<td valign="top">
										<?=roundEx(DoubleVal($arBasket["WEIGHT"]/$WEIGHT_KOEF), SALE_VALUE_PRECISION)." ".$WEIGHT_UNIT;?>
									</td>
									<td valign="top">
							...
							<tr>
								...
								<td align="right" colspan="6">
									<?=roundEx(DoubleVal($summWeight/$WEIGHT_KOEF), SALE_VALUE_PRECISION)." ".$WEIGHT_UNIT;?>
								</td>
							</tr>
							<tr>
								<td align="right">
