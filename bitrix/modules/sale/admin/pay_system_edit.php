...
$tabControl->EndTab();
	...
	for ($tpInd = 0; $tpInd < count($arPersonTypeList); $tpInd++)
	{
		...
		<?endif;?>
		<tr>
			<td width="40%" align="right"><span class="required">*</span><?= GetMessage("SPS_NAME") ?>:</td>
			<td width="60%">
				<input type="text" name="NAME_<?= $arPersonType["ID"] ?>" value="<?= $f_NAME ?>" size="60">
			</td>
		</tr>
		<tr>
			<td width="40%" valign="top" align="right"><span class="required">*</span><?= GetMessage("SPS_ACT_FILE") ?>:</td>
			<td width="60%" valign="top">
				<?
