			...
			<div id="header" itemscope itemtype = "http://schema.org/LocalBusiness">
				<table id="logo" cellspacing="0">
					<tr>
						...
						<td id="logo-text"><a href="<?=SITE_DIR?>" title="<?=GetMessage("HEADER_TO_MAIN_PAGE")?>"><span itemprop = "name"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", array("AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/company_name.php"), false);?></span></a></td>
					</tr>
				</table>
				<table id="schedule">
					<tr>
